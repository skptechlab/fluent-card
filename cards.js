...
export const cardSets = [
  {
    ...
    { id: 1, name: "Mog Masquaredes Broker", cost: 2, attack: 2, health: 3, texture: "/cards/a1.webp", weight: 4, lore: "A shadowy figure trading secrets for bitcoin in gilded parlors." },
            ...
            { id: 8, name: "Yield Nexus", cost: 4, attack: 2, health: 2, ability: "Combo: +2 Attack if played after Quantum Seer", texture: "/cards/a8_1.webp", weight: 3, lore: "A confluence of liquidity pools amplifying returns through cross-chain arbitrage." },
